...
* Send page to device
  - Click the device name, find device browser (Chrome or Chrome beta) in the list, paste the entire URL (http://127.0.0.1:4000/udacity-fsnd01-p02-portfolio/) into the new tab box.
